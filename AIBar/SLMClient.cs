...
public partial class SLMClient(string modelName = "gemma3:4b", string ollamaPath = "ollama") : IDisposable
{
    ...
    private const string SystemPrompt = """
        ...
        "open"          | the process name, like "notepad" or "firefox""open"          
        ...
        6. If the user asks you to take a screenshot, use the "tkaeScreenshot" action, the "argument" can be empty string
        ...
        If the prompt does lead to any action, use the "response" action and responds normally, with natural language, with articulated sentences. If you have doubts use the response action
